...
data = pd.read_csv(r'Data\5.filled_data.csv')

# Define columns 
columns_to_fill = ["deficiency_finding", "root_cause_analysis"]
relevant_features = ["description_overview", "immediate_causes"]
...
filled_data.to_csv(os.path.join('Data', '6.filled_data.csv'), index=False)
