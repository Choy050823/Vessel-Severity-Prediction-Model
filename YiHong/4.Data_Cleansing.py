...
df = pd.read_csv(r'Data\0.psc_severity_train.csv', dtype={'deficiency_code': str})
...
df_cleansed = filtered_df.drop(filtered_df.columns[[0,2,3,6,7]], axis=1)

# Save the new DataFrame to a new CSV file
df_cleansed.to_csv(os.path.join('Data', '4.cleansed_data.csv'), index=False)
