...
train_df = pd.read_csv(r'Data/final_data.csv')
...
# Load the test data
test_df0 = pd.read_csv(r'Data/0.psc_severity_test.csv')
...
X_test = test_df.drop(columns=['adjusted_severity'], errors='ignore')  # Ensure no target column
